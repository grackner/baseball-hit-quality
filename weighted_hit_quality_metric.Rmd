...
library(tidyverse)
library(plotly)
df <- read.csv(here("<data hidden for privacy>"))
head(df)
...
Play result (20%) would be weighed the most because scoring is important to winning games and the better the outcome of a hit, the greater the liklihood to score a run. Play result weights would be ranked based on ordinal values (home run is worth more than an out). 
